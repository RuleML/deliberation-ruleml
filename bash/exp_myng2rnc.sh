...
schemaFile="${RNC_HOME}naffologeq_normal.rnc"
...
myngcode="b3f-d7-a7-l1-p3ff-i7f-tef3f-q7-ef-s50"
"${BASH_HOME}aux_myng2rnc.sh" "${myngcode}" "${RNC_HOME}naffologeqPSOA_normal4xsd.rnc"
echo "Finished creating relaxng"
schemaFile="${RNC_HOME}naffologeq_normal4xsd.rnc"
echo "schemaFile: ${schemaFile}"
# rulemlFile="${RNC_TEST_SUITE_HOME}datalogPSOA-test-suite/datalogPSOA_normal.ruleml"
# echo "rulemlFile: ${rulemlFile}"
"${BASH_HOME}aux_valrnc.sh" "${schemaFile}"
...
myngcode="b7-d7-a7-l1-p3cf-i7-tef0f-q1-e0-s50"
...
myngcode="bf-d7-a7-l1-p3cf-i7-tef0f-q7-e3-s50"
...
myngcode="b3f-d7-a7-l1-p3ff-i7f-tef3f-q7-ef-s48"
"${BASH_HOME}aux_myng2rnc.sh" "${myngcode}" "${RNC_HOME}naffologeqPSOA_normal4simp.rnc"
echo "Finished creating relaxng"
schemaFile="${RNC_HOME}naffologeq_normal4simp.rnc"
echo "schemaFile: ${schemaFile}"
# rulemlFile="${RNC_TEST_SUITE_HOME}datalogPSOA-test-suite/datalogPSOA_normal.ruleml"
# echo "rulemlFile: ${rulemlFile}"
"${BASH_HOME}aux_valrnc.sh" "${schemaFile}"
...
myngcode="b7-d7-a7-l1-p3cf-i7-tef0f-q1-e0-s48"
...
myngcode="bf-d7-a7-l1-p3cf-i7-tef0f-q7-e3-s48"
